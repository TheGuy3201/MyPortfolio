...
<>
    ...
    <img src="/res/Pic of me.jpg" alt="Picture of Joshua D" className="HomeSelfImg" onClick={handleImageClick}/>
    ...
    <nav>
        <button className="RedirectButton" onClick={() => navigateTo("/about")}>About Me <img className="RedirectIcon" src="https://static.vecteezy.com/system/resources/thumbnails/033/882/148/small_2x/transparent-background-person-icon-free-png.png" alt="Person icon - learn about me"/> </button>
        <button className="RedirectButton" onClick={() => navigateTo("/project")}>My Projects <img className="RedirectIcon" src="https://cdn-icons-png.freepik.com/256/12148/12148631.png?semt=ais_hybrid" alt="Projects icon - view my work"/> </button>
    </nav>
</>
);
});
