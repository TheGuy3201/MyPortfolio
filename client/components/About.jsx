    ...
    <>
        ...
        <div className="DualPanelContainer"> {/* Essentially a two column layout page */}
            ...
            <div className="Description">
                ...
                <p>I am a 3rd year software engineering technology student at Centennial College, specializing in Game Programming. Throughout my time at Centennial College, I have developed skills in a variety of programming languages such as C#, Java, JavaScript, HTML/CSS, Kotlin, C++, MySQL and many more. With these skills, I have exceeded expectations, overcome challenges, and completed various projects. In addition, I believe in bringing a friendly and positive attitude towards work and relationships to build strong connections and to succeed in anything I work towards.</p>
            </div>
        </div>
    </>
    );
